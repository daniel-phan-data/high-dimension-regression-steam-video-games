...
```
cd existing_repo
git remote add origin https://gitlab-mi.univ-reims.fr/ousa0001/model_lin_steam.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab-mi.univ-reims.fr/ousa0001/model_lin_steam/-/settings/integrations)
